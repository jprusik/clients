 ...
 */
const iconPathFill = (color: string) => css`
  fill: ${color};
`;

const iconPathStroke = (color: string) => css`
  stroke: ${color};
`;

export function Close({ color, theme }: { color?: string; theme: Theme }) {
  return html`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
      <path
        class=${iconPathFill(color || themes[theme].text.main)}
...
export function AngleDown({ color, theme }: { color?: string; theme: Theme }) {
  return html`
...
export function Folder({ color, theme }: { color?: string; theme: Theme }) {
  return html`
...
export function User({ color, theme }: { color?: string; theme: Theme }) {
  return html`
...
export function ExclamationTriangle({ color, theme }: { color?: string; theme: Theme }) {
  return html`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 22" fill="none">
      <path
        class=${iconPathFill(color || themes[theme].text.main)}
...
export function PencilSquare({ color, theme }: { color?: string; theme: Theme }) {
  return html`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
      <path
        class=${iconPathFill(color || themes[theme].text.main)}
...
export function Business({ color, theme }: { color?: string; theme: Theme }) {
  return html`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
      <path
        class=${iconPathFill(color || themes[theme].text.main)}
      ...
      />
      <path
        class=${iconPathStroke(color || themes[theme].text.main)}
...
export function Globe({ color, theme }: { color?: string; theme: Theme }) {
  return html`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
      <path
        class=${iconPathFill(color || themes[theme].text.main)}
