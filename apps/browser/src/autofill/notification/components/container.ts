      ...
      ${showBody
        ? NotificationBody({
            ...
            children: [
              ...
              ItemRow({ theme, children: CipherItem({ cipher, notificationType: "add", theme, handleAction: () => {window.alert('Go Gadget go!')} }) }),
              ItemRow({ theme, children: CipherItem({ cipher, notificationType: "add", theme }) }),
              ItemRow({ theme, children: CipherItem({ cipher, notificationType: "update", theme, handleAction: () => {window.alert('How do you solve a problem like aria?')}}) }),
            ],
          })
        : null}
      ${NotificationFooter({ theme, children: [ type === "update" ?
        ButtonRow({ theme }) :
