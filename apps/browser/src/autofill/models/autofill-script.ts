...
export type FillScriptActions = "click_on_opid" | "focus_by_opid" | "fill_by_opid" | "fill_by_targeted_field_type" | "click_on_targeted_field_type" | "focus_by_targeted_field_type";

export type FillScript = [action: FillScriptActions, actionTarget: AutofillFieldQualifierType | string, value?: string];
...
export type AutofillInsertActions = {
  ...
  fill_by_targeted_field_type: ({ fieldType, value }: {fieldType: AutofillFieldQualifierType, value: string}) => void,
